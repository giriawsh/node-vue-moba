...
export default {
  ...
  methods: {
    ...
    async fetch() {
      ...
      // this.model = res.data;//会把服务端数据完整替换
      this.model = Object.assign({}, this.model, res.data);//最终得到的是this.model+res.data的数据

    },
    // afterUpload(res) {
    //   // this.$set(this.model, 'icon', res.url);//vue的显式赋值
